...
<div class="bg-white shadow-sm rounded-lg">
    <div class="p-6">
        <div class="flex justify-between items-center mb-6">
            <h2 class="text-2xl font-semibold text-gray-900">Reporte de Ventas</h2>
        ...
        <!-- Filtros -->
        <div class="mb-6">
            <form action="{{ route('reports.sales') }}" method="GET" class="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div>
                ...
                <div class="p-4">
                    <div class="flex items-center">
                        ...
                        <div class="ml-5">
                            ...
                            <p class="mt-1 text-2xl font-semibold text-gray-900">${{ number_format($totalSales, 2) }}</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="p-4">
                    <div class="flex items-center">
                        ...
                        <div class="ml-5">
                            ...
                            <p class="mt-1 text-2xl font-semibold text-gray-900">{{ $totalOrders }}</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="p-4">
                    <div class="flex items-center">
                        ...
                        <div class="ml-5">
                            ...
                            <p class="mt-1 text-2xl font-semibold text-gray-900">{{ $activeCustomers }}</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="p-4">
                    <div class="flex items-center">
                        ...
                        <div class="ml-5">
                            ...
                            <p class="mt-1 text-2xl font-semibold text-gray-900">{{ $productsSold }}</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="bg-white overflow-hidden shadow-sm rounded-lg">
            <div class="p-6">
                <h3 class="text-lg font-medium text-gray-900 mb-4">Pedidos Recientes</h3>
                <div class="overflow-x-auto">
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            @empty
                            <tr>
                                <td colspan="5" class="px-6 py-4 text-center text-sm text-gray-500">No se encontraron pedidos</td>
                            </tr>
                            @endforelse
                        </tbody>
                    </table>
